...
_MODULE_MAP = {
    ...
    'read_QE_xml': 'inputs',
    'read_VASP': 'inputs',
    'read_inputfile_xml_parse': 'inputs',
    'read_upf': 'inputs',
    'read_sh_nl': 'inputs',
    'read_pao_output': 'inputs',
    'file_io': 'inputs',
    'basis_presets': 'inputs',
    # projection
    'do_atwfc_proj': 'projection',
    'projection_operator': 'projection',
    'do_projectability': 'projection',
    'do_minimal': 'projection',
    'do_ortho': 'projection',
    'do_non_ortho': 'projection',
    'upf_gaussfit': 'projection',
    # hamiltonian
    'do_build_pao_hamiltonian': 'hamiltonian',
    'do_doubling': 'hamiltonian',
    'do_real_space': 'hamiltonian',
    'pao_sym': 'hamiltonian',
    ...
    'do_d2Hd2k': 'hamiltonian',
    # spectrum
    'do_eigh': 'spectrum',
    'do_bands': 'spectrum',
    'sparse_bands': 'spectrum',
    'kpnts_interpolation_mesh': 'spectrum',
    'do_site_projected_bands': 'spectrum',
    'do_band_curvature': 'spectrum',
    'do_effective_mass': 'spectrum',
    'do_dos': 'spectrum',
    'do_pdos': 'spectrum',
    'do_Efermi': 'spectrum',
    'do_adaptive_smearing': 'spectrum',
    # topology
    'do_topology': 'topology',
    'do_berry_phase': 'topology',
    'do_find_Weyl': 'topology',
    'do_fermisurf': 'topology',
    'do_spin_texture': 'topology',
    'do_wave_function_site_projection': 'topology',
    'pfaffian': 'topology',
    'clebsch_gordan': 'topology',
    # response
    'do_epsilon': 'response',
    'do_Hall': 'response',
    'do_rashba_edelstein': 'response',
    'do_ipr': 'response',
    # boltzmann
    'TauModel': 'boltzmann',
    'do_tau_models': 'boltzmann',
    'do_Boltz_tensors': 'boltzmann',
    'do_transport': 'boltzmann',
    'do_doping': 'boltzmann',
    # models
    'models': 'models',
    'sk_fitting': 'models',
    ...
    'dual_params': 'models',
    'band_unfold': 'models',
    'surface_project': 'models',
    # writers
    'write2xsf': 'writers',
    'write2bxsf': 'writers',
    'write2bxsf4skeaf': 'writers',
    'write4bt2': 'writers',
    # utils
    'communication': 'utils',
    'constants': 'utils',
    ...
    'pyints': 'utils',
    'perturb_split': 'utils',
    'get_K_grid_fft': 'utils',
    'get_R_grid_fft': 'utils',
    'zero_pad': 'utils',
    'header': 'utils',
    'report_exception': 'utils',
