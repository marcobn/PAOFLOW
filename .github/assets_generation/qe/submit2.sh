...
cd "$SLURM_SUBMIT_DIR"
script_dir="."
chmod u+x "$script_dir/job2.sh"
"$script_dir/job2.sh" --paoflow-examples --paoflow-reference-dir Reference2 --compare-paoflow-reference example10
# "$script_dir/job2.sh" --qe example10
