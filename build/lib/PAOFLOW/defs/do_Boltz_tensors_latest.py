...
def do_Boltz_tensors_smearing ( data_controller, temp, ene, velkp, ispin ):
  ...
  L0aux, tau_aux, norm_aux = L_loop(data_controller, temp, attributes['smearing'], ene, velkp, t_tensor, 0, ispin)
...
def get_tau (temp,data_controller, channels ):
  ...
  rho = 4.59e3   #kg/m^3
  a = 10.8301e-10 #metres
  Ea = 15*1.60217662e-19 #joules
  Eo = 30*1.60217662e-19
  temp *= 1.60217662e-19
  e = 1.60217662e-19
  nd = 38e26 #doping in /m^3
