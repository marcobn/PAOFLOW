...
def do_transport ( data_controller, temps,emin,emax,ne,ene, velkp,a_imp,a_ac,a_pop,a_op,a_iv,a_pac,write_to_file):
  ...
  #### Doest it make sense to compute the Taus here, since they are currently calculated once per temp per spin?
  ## Most likely.... Still need a comprehensive list of variables & parameters
