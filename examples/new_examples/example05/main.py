...
SAVEDIR = os.path.join(HERE, 'Pt1.save')
UPF = os.path.join(HERE, 'Pt1.save/Pt.upf')
BASISPATH = os.path.join(HERE, 'BASIS_PS') + os.sep
OUTPUTDIR = 'output'

NPOOL = 1
SMEARING = 'gauss'
SPIN_ORBIT = True   # set True for spin-orbit (noncollinear) runs
...
def run_properties():
    ...
    p.topology(Berry=True, eff_mass=True, spol=2, ipol=0, jpol=1)
    ...
    p.spin_Hall(emin=EMIN, emax=EMAX, s_tensor=[[0, 1, 2]])
