...
module_pre_reqs = {
    'add_external_fields': ['projectability'],
...
key_error_strings = {
    'U': "Projections must be computed before projectability. Call 'read_atomic_proj_QE' to read projections from the output of projwfc.x",
