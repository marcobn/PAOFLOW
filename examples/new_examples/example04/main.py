...
SAVEDIR = os.path.join(HERE, 'Fe1.save')
UPF = os.path.join(HERE, 'Fe1.save/Fe.upf')
...
def run_properties():
    ...
    p.anomalous_Hall(do_ac=True, emin=EMIN, emax=EMAX, a_tensor=[[0, 1]])
